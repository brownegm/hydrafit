---
title: "How to fit and bootstrap hydraulics parameters"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to fit and bootstrap hydraulics parameters}
...
if(require(dplyr)){
cebe <- cebe_efm %>%
  dplyr::mutate(data.type = rep(1, dim(cebe_efm)[1]), .before=psi) }

cebe$to_split <- paste(cebe$species, cebe$data.type)
...
species_list <- unique(cebe$to_split)
```
...
for (ii in 1:length(species_list)){
  ...
  Linear_fits = fit_linear(data_by_sp, plot=F, xlab="Water Potential (MPa)", ylab="Leaf Hydraulic Conductance (mmol m^-2 s-1)")
  Linear_fits$D<- NA # placeholder to keep all of the data frames the same size
  Linear_fits$sterrorD<- NA
...
# modelfitting_results_linear$psi_k20<- (0.8-1)*(-modelfitting_results_linear$A)*-1/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k50<- (0.5-1)*(-modelfitting_results_linear$A)*-1/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k80<- (0.2-1)*(-modelfitting_results_linear$A)*-1/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k95<- (0.05-1)*(-modelfitting_results_linear$A)*-1/(modelfitting_results_linear$B)
# 
# 
# # PX values with max at 0.1 MPa
# modelfitting_results_linear$gmax_at0.1 <- (modelfitting_results_linear$B*0.1)+modelfitting_results_linear$A
# modelfitting_results_linear$psi_k20_at0.1<- ((0.8*modelfitting_results_linear$gmax_at0.1)-modelfitting_results_linear$A)/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k50_at0.1<- ((0.5*modelfitting_results_linear$gmax_at0.1)-modelfitting_results_linear$A)/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k80_at0.1<- ((0.2*modelfitting_results_linear$gmax_at0.1)-modelfitting_results_linear$A)/(modelfitting_results_linear$B)
# modelfitting_results_linear$psi_k95_at0.1<- ((0.05*modelfitting_results_linear$gmax_at0.1)-modelfitting_results_linear$A)/(modelfitting_results_linear$B)
