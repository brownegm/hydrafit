...
vignette: >
  %\VignetteIndexEntry{How to fit hydraulics parameters (multiple)}
...
for( i in 1:dim(mod_bestfit)[1]){
  ...
  boot_vals<-bootPX(mod_bestfit,
                    fx_type=mod_bestfit[i,"data.type"], 
                    px=0.5, psi_max = 0.1)%>%unlist()# suppressing warnings here can help if errors resulting from NAs stop you from moving forward. 
